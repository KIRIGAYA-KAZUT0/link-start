...
def tik():
	titik = ['.   ','..  ','... ']
	for o in titik:
		print("\r\033[1;36mSedang masuk \x1b[1;97m"+o),;sys.stdout.flush();time.sleep(1)
...
def siapa():
	os.system('clear')
	nama = raw_input("\033[1;32mNama player? \033[1;91m: \033[1;92m")
	if nama =="":
		...
		os.system('clear')
		jalan("\033[1;32mSelamat datang di isekai: \033[1;36m" +nama+ "\n")
		time.sleep(1)
		loginSC()
